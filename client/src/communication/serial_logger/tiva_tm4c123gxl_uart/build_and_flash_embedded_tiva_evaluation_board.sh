...
SOURCES=`echo tiva_startup_gcc.c tiva_main.c ../../../common/globals.c ../tiva_tm4c123gxl_launchpad_serial_logger.c `
...
arm-none-eabi-gcc -T ${LD_SCRIPT} --entry ResetISR -Wl,--gc-sections -g -mthumb -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -Os -ffunction-sections -fdata-sections -MD -std=c99 -Wall -pedantic -DPART_${MCU} -I${TIVAWARE_PATH} -I../../../vendors/tiva_tm4c123gxl_launchpad -DTARGET_IS_BLIZZARD_RA1 ${SOURCES} tiva_build/*.o -o "tiva_build/a.out"
